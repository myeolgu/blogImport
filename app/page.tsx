...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#101114] text-white">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6"><a href="/" className="text-lg font-bold tracking-tight">ToolScout</a><div className="flex items-center gap-4"><a href="/report" className="text-xs text-white/55 hover:text-white">Free report</a><a href="/newsletter" className="rounded-full border border-white/15 px-4 py-2 text-xs text-white/60 hover:border-[#a7f3d0]">Creator updates</a></div></nav>
